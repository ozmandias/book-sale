...
<body>
      ...
      <div class="m-5">
        <div class=" d-flex justify-content-between me-5">
          <div class="heading">
            ...
            <button class="btn btn-info text-white" onclick="add_order()">Add</button>
          </div>
    ...
    <script src="./programming/order/order_script.js"></script>
</body>
</html>